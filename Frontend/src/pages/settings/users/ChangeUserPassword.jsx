...
const ChangeUserPassword = ({user, onClose, onChanged,}) => {
            ...
            <div className="w-full max-w-xl overflow-hidden rounded-xl border border-slate-200 bg-white shadow-2xl">
                ...
                <div className="flex items-start justify-between gap-4 border-b border-slate-200 px-5 py-4">
                    <div className="flex items-center gap-3">
                        <span className="grid h-10 w-10 place-items-center rounded-md bg-violet-100 text-violet-700">
                            <KeyRound size={20} />
                        </span>

                        <div>
                            <p className="text-xs font-semibold uppercase tracking-wide text-violet-700">User Management</p>
                ...
                <div className="border-b border-slate-100 bg-slate-50 px-5 py-4">
                    <p className="text-xs font-medium uppercase tracking-wide text-slate-500">Changing password for</p>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {/* Warning */}
                    <div className="mx-5 mb-5 rounded-lg border border-violet-200 bg-violet-50 px-4 py-3">
                        <p className="text-xs leading-5 text-violet-800">
                            Changing this password will sign the
                            user out of their existing sessions.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col-reverse gap-3 border-t border-slate-200 px-5 py-4 sm:flex-row sm:justify-end">
                        ...
                        <button
                            ...
                            className="inline-flex h-10 items-center justify-center gap-2 rounded-md bg-violet-600 px-5 text-sm font-semibold text-white transition hover:bg-violet-700 disabled:cursor-not-allowed disabled:opacity-50"
                        >
