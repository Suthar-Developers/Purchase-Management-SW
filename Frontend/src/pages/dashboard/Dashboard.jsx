    ...
    return (
        <div className='flex w-full border-b border-gray-500'>
            <div className='w-3/8 h-full border-r border-gray-500 px-2'>
                <h1 className='text-lg font-bold mx-6 mb-3 text-center pt-6'>Dashboard</h1>
                <div className='flex flex-wrap w-full justify-around'>
                    <Cards cardName="Fresh PR" number="110" > </Cards>
                    <Cards cardName={<span className='text-sm'><span className='text-sm font-semibold'>Approved PR </span>(Pending for PO)</span>} number="100" > </Cards>
