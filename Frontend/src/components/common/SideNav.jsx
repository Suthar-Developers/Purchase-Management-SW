...
const SideNav = () => {
    ...
    return (
        <div className='flex flex-col items-center text-xs w-fit px-3 h-screen bg-slate-900 text-gray-300 shadow-r-xl'>
            ...
            <div className='pb-2'>
                <Link to={'/'}>
                    <div className={`btn py-2 rounded w-3xs mb-3 ${isActive('/') ? 'text-white font-semibold bg-gray-800' : ''}`}>
                ...
                <Link to={'/projects'}>
                    <div className={`btn py-2 rounded w-3xs mb-3 ${isActive('/projects') ? 'text-white font-semibold bg-gray-800' : ''}`}>
                        <button className='flex items-center gap-2 ml-2 text-left'>
                ...
                <Link to={'/vendors'}>
                    <div className={`btn py-2 rounded w-3xs mb-3 ${isActive('/vendors') ? 'text-white font-semibold bg-gray-800' : ''}`}>
                        <button className='flex items-center gap-2 ml-2 text-left'>
            ...
            <div className='pb-2'>
                <Link to={'/purchase-requests'}>
                    <div className={`btn py-2 rounded w-3xs mb-3 ${isActive('/purchase-requests') ? 'text-white font-semibold bg-gray-800' : ''}`}>
                        <button className='flex items-center gap-2 ml-2 text-left'>
                ...
                <div onClick={() => setOpenPO(!openPO)} className="flex items-center justify-between cursor-pointer">
                    <div className='btn py-2 rounded w-3xs mb-1'>
                        <button className='flex items-center gap-2 ml-2 text-left'>
                ...
                <div className={`flex flex-col gap-1 mb-4 text-xs overflow-hidden transition-all duration-300 ${openPO ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0'}`}>
                ...
                <div className={`btn py-2 rounded w-3xs mb-1 ${isActive('/good-receipt') ? 'text-white font-semibold bg-gray-800' : ''}`}>
                    <button className='flex items-center gap-2 ml-2 text-left'>
            ...
            <div className='pb-2'>
                <div className={`btn py-2 rounded w-3xs mb-2 ${isActive('/stocks') ? 'text-white font-semibold bg-gray-800' : ''}`}>
                    <button className='flex items-center gap-2 ml-2 text-left'>
                ...
                <div className={`btn py-2 rounded w-3xs mb-2 ${isActive('/bills') ? 'text-white font-semibold bg-gray-800' : ''}`}>
                    <button className='flex items-center gap-2 ml-2 text-left'>
            ...
            <div>
                <div className={`btn py-2 rounded w-3xs mb-2 ${isActive('/setting') ? 'text-white font-semibold bg-gray-800' : ''}`}>
                    <button className='flex items-center gap-2 ml-2 text-left'>
