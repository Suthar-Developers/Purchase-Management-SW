...
const PurchaseRequestList = ({ onCreate }) => {
  ...
  // Downloads purchase requests by created/delivery date using the selected range.
      ...
      <div className="bg-white rounded-2xl shadow-2xl h-[85%] flex flex-col p-6 overflow-auto">
        ...
        <div className="px-6 flex flex-wrap justify-between items-center gap-2">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button icon={<i className="fa-solid fa-download"></i>} onClick={downloadRequestsPdf} className='grid h-9 w-9 place-items-center rounded-lg border border-slate-200 text-slate-700 hover:bg-slate-100 hover:cursor-pointer' title="Download purchase requests PDF" aria-label="Download purchase requests PDF" />
