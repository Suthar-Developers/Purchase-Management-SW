...
const { createUser, getAllUsers, getPermissionModules, getUserPermissionDetails, updateUserPermissions, updateUser, updateUserStatus, resetUserPassword, changeUserPassword, deleteUser } = require('../controller/userController');
